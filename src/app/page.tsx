    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <section className="relative z-10 px-6 py-24 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 mt-8">
            Enterprise-Grade Compliance for Agentic AI
          </h1>
          <p className="text-xl md:text-2xl text-emerald-100 mb-10">
            Privnt helps you achieve and maintain <span className="text-emerald-400 font-semibold">SOC 2</span> & <span className="text-emerald-400 font-semibold">HIPAA</span> compliance—so you can build, deploy, and scale AI agents with confidence and trust.
          </p>
          <a
      ...
      <section id="why-compliance" className="relative z-10 px-6 py-20 bg-black/90 border-t border-b border-emerald-900/40">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-8">Why Compliance Matters</h2>
          <div className="grid md:grid-cols-3 gap-8 mb-10">
            <div className="flex flex-col items-center">
              ...
              <p className="text-emerald-100 mt-2">Non-compliance can result in regulatory fines up to <span className="font-bold">$1M+</span> and lost business opportunities.</p>
            </div>
            <div className="flex flex-col items-center">
              <FileText className="w-10 h-10 text-emerald-400 mb-3" />
              <span className="text-lg font-semibold text-white">Due Diligence</span>
              <p className="text-emerald-100 mt-2">Investors and enterprise customers require proof of compliance before closing deals.</p>
            </div>
            <div className="flex flex-col items-center">
              <Sparkles className="w-10 h-10 text-blue-400 mb-3" />
              <span className="text-lg font-semibold text-white">AI Under Scrutiny</span>
              <p className="text-emerald-100 mt-2">AI companies face increasing regulatory attention—compliance is now a competitive advantage.</p>
            </div>
          </div>
          <div className="text-emerald-300 text-sm mt-6">
            <span className="font-medium">82%</span> of AI startups fail their first compliance audit. <span className="font-medium">68%</span> of enterprise deals require SOC 2 or HIPAA.
          </div>
        </div>
      </section>
      ...
      <section id="standards" className="relative z-10 px-6 py-20 bg-black/80">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-8">SOC 2 & HIPAA for Agentic AI</h2>
          <div className="grid md:grid-cols-2 gap-10 text-left">
            <div className="bg-black/70 rounded-2xl p-8 shadow-md border border-emerald-900/40">
              <h3 className="text-2xl font-semibold text-emerald-400 mb-3">What is SOC 2?</h3>
              <p className="text-emerald-100 mb-2">SOC 2 is the gold standard for data security, availability, and privacy. It’s required by most enterprise customers and signals your commitment to protecting client data.</p>
            ...
            <div className="bg-black/70 rounded-2xl p-8 shadow-md border border-emerald-900/40">
              <h3 className="text-2xl font-semibold text-emerald-400 mb-3">What is HIPAA?</h3>
              <p className="text-emerald-100 mb-2">HIPAA is essential for any AI company handling health data. It ensures the privacy and security of protected health information (PHI) and is mandatory for healthcare integrations.</p>
              <ul className="list-disc ml-6 text-emerald-200">
                <li>PHI encryption & access controls</li>
          ...
          <div className="mt-12 text-lg text-emerald-200">
            Privnt automates SOC 2 & HIPAA compliance for agentic AI—so you can focus on innovation, not paperwork.
          </div>
        </div>
      </section>
